...
<h1 className="display-3 text-white animated slideInDown" style={{ fontSize: '2.5rem' }}>                Carefully crafted tours for unforgettable experiences
                </h1>
...
<h2 className="display-5" style={{ color: "black" }}>
  Sri Lanka Tour Packages Recommended by Opulent
            ...
            <p className="text-muted" style={{ fontSize: '24px', lineHeight: '1.8', color: '#000000' }}>Choose your perfect adventure</p>
          </div>
